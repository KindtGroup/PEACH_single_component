...
!!!! Apr5 2018 input from first round fitting by Xiaokun Zhang
read (*,*) nguess
write (*,*) "The number of Kactual values that are given as a first round guess is ", nguess,".\n\n"
do nguess=1, nguess
   read (*,*) i,Kactual(i)
   write (*,*) i,Kactual(i)
enddo
...
do iset=1,nsets
  ...
  do j=2,ni_in(iset)
    ...
    write (*,*) i,aveN(i,iset),stdvN(i,iset),ci_gt_0(i,iset)
  enddo 
...
!!!!! Xiaokun Zhang comment out 
!!!no need to generate Kactual
!write (*,*) "##########"
...
write (13,*) "# "
do i=1,NsimMax
  write (13,*) i,0.0d0,0.0d0,Kactual(i),-log(Kactual(i))-(i-1)*log(nc1)
enddo
close(UNIT=13)
      ...
      if (nsamp(i).gt.0) then
        do iset=1,nsets 
          ...
          if (ci_gt_0(i,iset)) then
            ...
            ! Xiaokun modify it for second pass
